...
const memory={
	...
	shift: function (vec) {
		...
		let note1=JSON.parse(f)["note"];
		let note2=JSON.parse(t)["note"];
...
const notes={
	...
	inNote: function(clicked){
        ...
        else if(bt.getAttribute("data-num")){
        	dragging(bt)
    ...
    let butUndo=document.getElementById("buttonUndo");
        butUndo.style.display="none";
    let butBack=document.createElement("button");
    butBack.setAttribute("class","back");
    ...
    noteEdit:function (note) {
        ...
        let butEdit=document.createElement("button");
            ...
            butEdit.setAttribute("data-num",b);
    ...
    changeNote:function (clicked) {
        ...
        let butCreate=document.querySelector("#buttonCreate");
            butCreate.style.display="inline";
        let butUndu=document.querySelector("#buttonUndo");
            butUndu.style.display="inline";
